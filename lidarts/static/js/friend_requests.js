$(document).ready(function () {
    ...
    $('.cancel-challenge').click(function (event) {
        var cancel_challenge_url = $('#cancel_challenge_url').data()['url'];
        var hashid = this.id.replace('cancel-challenge-', '');

        $.post(cancel_challenge_url + hashid,
            function () {
                $(document.getElementById('element-cancel-challenge-' + hashid)).html('<strong style="color: #bb4444">Challenge canceled.</strong>');
            }
        );
    });
