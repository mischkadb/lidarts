...
class TournamentStageRound(db.Model):
    ...
    games = db.relationship("TournamentGame", back_populates="tournament_round", order_by='TournamentGame.tournament_stage_game_id')
...
class TournamentGame(db.Model):
    ...
    match_is_bye = db.Column(db.Boolean, default=False)
    p1_ready = db.Column(db.Boolean, server_default='f')
    p2_ready = db.Column(db.Boolean, server_default='f')
